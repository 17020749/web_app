...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'data1' => [
            'driver' => 'sqlsrv',
            'url' => env('DATABASE_DATA1_URL'),
            'host' => env('DB_DATA1_HOST', 'localhost'),
            'port' => env('DB_DATA1_PORT', '1433'),
            'database' => env('DB_DATA1_DATABASE', 'forge'),
            'username' => env('DB_DATA1_USERNAME', 'forge'),
            'password' => env('DB_DATA1_PASSWORD', ''),
            'charset' => 'utf8',
            'prefix' => '',
            'prefix_indexes' => true,
        ...
        'data2' => [
            'driver' => 'sqlsrv',
            'url' => env('DATABASE_DATA2_URL'),
            'host' => env('DB_DATA2_HOST', 'localhost'),
            'port' => env('DB_DATA2_PORT', '1433'),
        ...
        'report' => [
            ...
            'host' => env('DB_REPORT_HOST', 'localhost'),
