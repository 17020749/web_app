        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex items-center justify-between pb-6 ...">
                ...
                <div class="relative">
                    ...
                    <input type="text" name="keySearch" id="table-search" value="" class="block p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search for items">
                    </form>
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 border-collapse">
                        ...
                        <tbody class="text-gray-700">
                            ...
                            <tr class="bg-white border dark:bg-gray-800 dark:border-gray-700 hover:bg-slate-200">
                                <td class="px-6 py-4 border border-slate-600">{{ $value->ID }}</td>
                            ...
                            @endforeach
                             @if($rawData->total()==0)
                            <tr class="bg-white border dark:bg-gray-800 dark:border-gray-700 hover:bg-slate-200 text-center">
                                <td class="px-6 py-4">Không tồn tại dữ liệu</td>
                            </tr>
                            @endif
                            @if (session('error'))
